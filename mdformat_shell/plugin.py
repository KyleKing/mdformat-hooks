...
from .mdit_plugins import shell_plugin


def add_cli_argument_group(group: argparse._ArgumentGroup) -> None:
    """Add options to the mdformat CLI.

    Stored in `mdit.options["mdformat"]["plugin"]["shell"]`
...
def update_mdit(mdit: MarkdownIt) -> None:
    """Update the parser."""
    mdit.use(shell_plugin)


def _render_shell(node: RenderTreeNode, context: RenderContext) -> str:
